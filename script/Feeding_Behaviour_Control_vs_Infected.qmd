...
df1 <- read.csv("../data/DENV_Cyno_data_feeding_behaviour_with_total_correct.csv")
df1$NHP <- "Cyno"
df1$virus <- "Dengue-2 virus"

df2 <- read.csv("../data/DENV_Squirrel_data_feeding_behaviour_with_total_correct.csv")
df2$NHP <- "Squirrel"
df2$virus <- "Dengue-2 virus"
df2$mosq_type <- NULL

df3 <- read.csv("../data/ZIKV_Squirrel_data_feeding_behaviour_with_total_correct.csv")
df3$NHP <- "Squirrel"
...
df4 <- read.csv("../data/ZIKV_Cyno_data_feeding_behaviour.csv")
df4$NHP <- "Cyno"
...
png(filename = here("output","figures","heterogeneity_among_hosts.png"), width = 1600, height = 750)
print(p_draw)
dev.off()
...
png(filename = here("output","figures","heterogeneity_among_hosts_suppl.png"), width = 1600, height = 750)
print(p_draw)
dev.off()
...
png(filename = here("output","figures","other_days_no_duration_errorbar.png"),
