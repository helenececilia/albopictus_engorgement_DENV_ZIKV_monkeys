...
# saveRDS(m1, "../output/engorgement_models/host_infection_simple.rds")
m1 <- readRDS("../output/engorgement_models/host_infection_simple.rds")
...
cold_squirrel <- df[df$species == "Squirrel" & df2$temp_estim_feed == min_T,]
hot_squirrel <- df[df$species == "Squirrel" & df2$temp_estim_feed == max_T,]
...
#                             species = rep(c("Squirrel","Cyno"), each = 247),
#                             temp_estim_feed = rep(seq(37.82,40.28,0.01),2))
...
# 0.479 ; 0.755 / 0.276 diff

# saveRDS(mod3, "../output/engorgement_models/host_infection_complete.rds")
mod3 <- readRDS("../output/engorgement_models/host_infection_complete.rds")
summary(mod3) 
